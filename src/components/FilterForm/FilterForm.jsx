...
export const FilterForm = () => {
  ...
  const handleSubmit = (event) => {
    ...
    const resultFilter = {
      camperType: radioBoxValue || undefined, // Змінено назву на camperType
      location: location || undefined,
      details: checkBoxValues || undefined,
    };
  ...
  const handleResetFilters = () => {
    ...
    document.getElementById("locationSelect").value = "default"; // Змінено id на locationSelect
